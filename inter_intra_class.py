...
def extend_cfg(cfg):
    ...
    # CoOp_OVE
    cfg.TRAINER.COOP_OVE = CN()
    cfg.TRAINER.COOP_OVE.N_CTX = 16  # number of context vectors
    cfg.TRAINER.COOP_OVE.LAMBDA_1 = 0.0  # weight for KD
    cfg.TRAINER.COOP_OVE.CSC = False  # class-specific context
    cfg.TRAINER.COOP_OVE.CTX_INIT = ""  # initialization words
    cfg.TRAINER.COOP_OVE.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.COOP_OVE.CLASS_TOKEN_POSITION = "end"  # 'middle' or 'end' or 'front'
    
    # CoOp_OVE_PG
    cfg.TRAINER.COOP_OVE_PG = CN()
    cfg.TRAINER.COOP_OVE_PG.N_CTX = 16  # number of context vectors
    cfg.TRAINER.COOP_OVE_PG.LAMBDA_1 = 0.0  # weight for KD
    cfg.TRAINER.COOP_OVE_PG.ALPHA = 1000.0  # precision for logit prior
    cfg.TRAINER.COOP_OVE_PG.M = 1           # the number of gibbs samples
    cfg.TRAINER.COOP_OVE_PG.CSC = False  # class-specific context
    cfg.TRAINER.COOP_OVE_PG.CTX_INIT = ""  # initialization words
    cfg.TRAINER.COOP_OVE_PG.PREC = "fp32"  # fp16, fp32, amp
    cfg.TRAINER.COOP_OVE_PG.CLASS_TOKEN_POSITION = "end"  # 'middle' or 'end' or 'front'
