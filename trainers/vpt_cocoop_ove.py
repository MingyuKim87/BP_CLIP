...
class PromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        n_ctx = cfg.TRAINER.VPT_COCOOP_OVE.N_CTX
        ctx_init = cfg.TRAINER.VPT_COCOOP_OVE.CTX_INIT
        self.L = cfg.TRAINER.VPT_COCOOP_OVE.L
        self.vpt_type = cfg.TRAINER.VPT_COCOOP_OVE.VPT_TYPE
        ...
        if self.vpt_type == "cocoopvpt":
            ...
            if cfg.TRAINER.VPT_COCOOP_OVE.PREC == "fp16":
                self.meta_net.half()
        else:
...
class VPT_CoCoOp_OVE(TrainerX):
    def check_cfg(self, cfg):
        assert cfg.TRAINER.VPT_COCOOP_OVE.PREC in ["fp16", "fp32", "amp"]
    ...
    def build_model(self):
        ...
        if cfg.TRAINER.VPT_COCOOP_OVE.PREC == "fp32" or cfg.TRAINER.VPT_COCOOP_OVE.PREC == "amp":
        ...
        self.lambda_1 = cfg.TRAINER.VPT_COCOOP_OVE.get("LAMBDA_1", None)
        self.eps = 1e-8
        assert self.lambda_1 is not None, "LAMBDA_1 must be given in cfg.TRAINER.VPT_COCOOP_OVE.LAMBDA_1"
        ...
        self.scaler = GradScaler() if cfg.TRAINER.VPT_COCOOP_OVE.PREC == "amp" else None
    ...
    def forward_backward(self, batch):
        ...
        prec = self.cfg.TRAINER.VPT_COCOOP_OVE.PREC
        if prec == "amp":
            with autocast():
